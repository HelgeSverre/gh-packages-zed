...
Inlang Language Server brings Inlang and Paraglide message inspection to Zed through LSP:
...
For Paraglide dot calls, Inlang Language Server resolves `m.some_key()` to either `some_key` or a dotted
