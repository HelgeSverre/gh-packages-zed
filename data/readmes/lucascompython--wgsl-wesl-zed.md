...
As wgsl-analyzer does not currently recognize all WESL syntax, errors from wgsl-analyzer are to be expected when working with WESL, related issues: [#2](https://github.com/lucascompython/wgsl-wesl-zed/issues/2), https://github.com/wgsl-analyzer/wgsl-analyzer/issues/632.
