...
3. Search "Formosa" and install

### Manual Installation

1. Clone this repository
2. Copy `themes/formosa.json` to `~/.config/zed/themes/`
3. Open Theme Selector (`Cmd+K Cmd+T`) and choose your preferred Formosa theme
