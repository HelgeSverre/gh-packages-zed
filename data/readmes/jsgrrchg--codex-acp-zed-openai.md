...
This fork was started to restore Zed's change-control layer around edits and permission-gated actions, and to maintain that behavior independently from the official Zed fork.
